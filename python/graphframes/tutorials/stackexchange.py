...
@click.option(
    ...
    help="Directory containing Stack Exchange XML/Parquet data (default: package data directory)",
)
def main(data_dir: str) -> None:
    """Convert Stack Exchange XML data dump to Parquet files for GraphFrames."""
